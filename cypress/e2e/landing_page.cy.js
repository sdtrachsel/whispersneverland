describe('landing page', () => {
  ...
  it.skip('should display a header with logo and navigation links', () => {
  ...
  it.skip('should welcome the user to the page', () => {
  ...
  it.skip('should have a button to start a new journal entry', () => {
